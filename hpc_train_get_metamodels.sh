...
#SBATCH --output=training_metamodels_%j.log
#SBATCH --error=training_metamodels_%j.err
...
export K_FOLD_DEVICE=${K_FOLD_DEVICE:-0,1}

python helpers/metamorphic_retraining_analysis.py
